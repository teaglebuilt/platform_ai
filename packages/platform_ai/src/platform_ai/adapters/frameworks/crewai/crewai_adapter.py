...
from platform_ai.adapters.frameworks.crewai.crewai_loader import construct_crew_from_config
from platform_ai.adapters.frameworks.crewai.tool_provider import CrewAIToolProvider
...
class CrewAdapter(AgentFramework):
    ...
    def run_agent_feature(
        ...
        feature_crew = construct_crew_from_config(
            ...
            tools=self.tool_provider.get_tools(feature_type, feature_path),
